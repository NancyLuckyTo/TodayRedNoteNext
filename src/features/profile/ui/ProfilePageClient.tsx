...
const ProfilePage = () => {
  ...
  const handlePostClick = useCallback(
    (postId: string) => {
      setScrollPosition(window.scrollY)
      // Next.js router doesn't support state like react-router-dom in push
      // We can use query params or just rely on global state/context if needed
      // For now, just navigate
      router.push(`/post/${postId}?disableRecommendations=true`)
    },
    [router, setScrollPosition]
  )
